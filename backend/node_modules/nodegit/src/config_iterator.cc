...
using namespace node;
  ...
  void GitConfigIterator::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    tpl->SetClassName(Nan::New("ConfigIterator").ToLocalChecked());
           ...
           Nan::SetMethod(tpl, "create", Create, nodegitExternal);
             Nan::SetMethod(tpl, "createGlob", GlobNew, nodegitExternal);
             Nan::SetMethod(tpl, "createMultivar", GitConfigMultivarIteratorNew, nodegitExternal);
            Nan::SetPrototypeMethod(tpl, "next", GitConfigNext, nodegitExternal);
    ...
    Nan::Set(target, Nan::New("ConfigIterator").ToLocalChecked(), constructor_template);
  }
...
// end convert_from_v8 block
  ...
  Nan::Callback *callback = new Nan::Callback(v8::Local<Function>::Cast(info[info.Length() - 1]));
  GlobNewWorker *worker = new GlobNewWorker(baton, callback, cleanupHandles);
...
// end convert_from_v8 block
  ...
  Nan::Callback *callback = new Nan::Callback(v8::Local<Function>::Cast(info[info.Length() - 1]));
  GitConfigMultivarIteratorNewWorker *worker = new GitConfigMultivarIteratorNewWorker(baton, callback, cleanupHandles);
