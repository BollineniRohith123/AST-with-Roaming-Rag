...
using namespace node;
  ...
  void GitCert::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    tpl->SetClassName(Nan::New("Cert").ToLocalChecked());
         ...
         Nan::SetPrototypeMethod(tpl, "certType", CertType, nodegitExternal);
    ...
    Nan::Set(target, Nan::New("Cert").ToLocalChecked(), constructor_template);
  }
 ...
 // start convert_to_v8 block
     v8ConversionSlot = Nan::New<Number>( cert_type);
