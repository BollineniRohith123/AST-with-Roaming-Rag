...
using namespace node;
  ...
  void GitNoteIterator::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    Nan::Set(target, Nan::New("NoteIterator").ToLocalChecked(), constructor_template);
  }
