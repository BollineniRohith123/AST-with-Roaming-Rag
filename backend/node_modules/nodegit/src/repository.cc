...
/*
     * @return Number  result    */
NAN_METHOD(GitRepository::OidType) {
  Nan::EscapableHandleScope scope;
...
NAN_METHOD(GitRepository::SetHeadDetached) {
  ...
  if (info.Length() == 0
    ...
    return Nan::ThrowError("Oid committish is required.");
  }
// start convert_from_v8 block
...
from_committish = Nan::ObjectWrap::Unwrap<GitOid>(Nan::To<v8::Object>(info[0]).ToLocalChecked())->GetValue();
  }
// end convert_from_v8 block
...
NAN_METHOD(GitRepository::SetHeadDetachedFromAnnotated) {
  ...
  if (info.Length() == 0 || !info[0]->IsObject()) {
    return Nan::ThrowError("AnnotatedCommit committish is required.");
  }

// start convert_from_v8 block
  const git_annotated_commit * from_committish = NULL;
from_committish = Nan::ObjectWrap::Unwrap<GitAnnotatedCommit>(Nan::To<v8::Object>(info[0]).ToLocalChecked())->GetValue();
// end convert_from_v8 block
