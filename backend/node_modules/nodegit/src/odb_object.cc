...
using namespace node;
  ...
  void GitOdbObject::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    Nan::Set(target, Nan::New("OdbObject").ToLocalChecked(), constructor_template);
  }
