...
using namespace node;
  ...
  void GitFilterSource::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    tpl->SetClassName(Nan::New("FilterSource").ToLocalChecked());
          ...
          Nan::SetPrototypeMethod(tpl, "repo", Repo, nodegitExternal);
    ...
    Nan::Set(target, Nan::New("FilterSource").ToLocalChecked(), constructor_template);
  }
