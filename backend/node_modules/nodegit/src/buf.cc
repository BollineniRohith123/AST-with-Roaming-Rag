...
using namespace node;
  ...
  void GitBuf::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    tpl->SetClassName(Nan::New("Buf").ToLocalChecked());
         ...
         Nan::SetPrototypeMethod(tpl, "reserved", Reserved, nodegitExternal);
...
,          from_datalen
 ...
 // start convert_to_v8 block
  ...
  // end convert_to_v8 block
    ...
    // end field block
     // start field block
    NAN_METHOD(GitBuf::Reserved) {
      v8::Local<v8::Value> v8ConversionSlot;

            size_t
           reserved =
          Nan::ObjectWrap::Unwrap<GitBuf>(info.This())->GetValue()->reserved;
 // start convert_to_v8 block
     v8ConversionSlot = Nan::New<Number>( reserved);
  // end convert_to_v8 block
      info.GetReturnValue().Set(v8ConversionSlot);
    }
    // end field block
