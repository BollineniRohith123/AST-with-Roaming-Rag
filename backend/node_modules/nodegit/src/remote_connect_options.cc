...
nodegit::ConfigurableClassWrapper<GitRemoteConnectOptionsTraits>::v8ConversionResult ConfigurableGitRemoteConnectOptions::fromJavascript(nodegit::Context *nodegitContext, v8::Local<v8::Value> input) {
  if (!input->IsObject()) {
    return {
