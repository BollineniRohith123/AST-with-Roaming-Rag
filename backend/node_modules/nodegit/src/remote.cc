  ...
  void GitRemote::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    tpl->SetClassName(Nan::New("Remote").ToLocalChecked());
           ...
           Nan::SetMethod(tpl, "addFetch", AddFetch, nodegitExternal);
            ...
            Nan::SetPrototypeMethod(tpl, "connectExt", ConnectExt, nodegitExternal);
...
/*
   ...
   */
NAN_METHOD(GitRemote::ConnectExt) {
  ...
  if (info.Length() == 1 || !info[1]->IsObject()) {
    return Nan::ThrowError("RemoteConnectOptions opts is required.");
  }
...
// end convert_from_v8 block
  ...
  Nan::Callback *callback = new Nan::Callback(v8::Local<Function>::Cast(info[info.Length() - 1]));
  ConnectExtWorker *worker = new ConnectExtWorker(baton, callback, cleanupHandles);
...
void GitRemote::ConnectExtWorker::HandleErrorCallback() {
  if (!GetIsCancelled()) {
    v8::Local<v8::Object> err = Nan::To<v8::Object>(Nan::Error(ErrorMessage())).ToLocalChecked();
    Nan::Set(err, Nan::New("errorFunction").ToLocalChecked(), Nan::New("Remote.connectExt").ToLocalChecked());
    v8::Local<v8::Value> argv[1] = {
      err
    };
    callback->Call(1, argv, async_resource);
  ...
  // end convert_to_v8 block
    ...
    if (baton->error) {
      ...
      if (baton->error->message) {
        ...
        err = Nan::To<v8::Object>(Nan::Error("Method connectExt has thrown an error.")).ToLocalChecked();
      }
      Nan::Set(err, Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
      Nan::Set(err, Nan::New("errorFunction").ToLocalChecked(), Nan::New("Remote.connectExt").ToLocalChecked());
      v8::Local<v8::Value> argv[1] = {
      ...
      if (!callbackFired) {
        v8::Local<v8::Object> err = Nan::To<v8::Object>(Nan::Error("Method connectExt has thrown an error.")).ToLocalChecked();
        Nan::Set(err, Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
        Nan::Set(err, Nan::New("errorFunction").ToLocalChecked(), Nan::New("Remote.connectExt").ToLocalChecked());
        v8::Local<v8::Value> argv[1] = {
          err
