...
using namespace node;
  ...
  void GitOid::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    tpl->SetClassName(Nan::New("Oid").ToLocalChecked());
          ...
          Nan::SetPrototypeMethod(tpl, "cmp", Cmp, nodegitExternal);
            Nan::SetPrototypeMethod(tpl, "cpy", Cpy, nodegitExternal);
            Nan::SetPrototypeMethod(tpl, "equal", Equal, nodegitExternal);
            Nan::SetPrototypeMethod(tpl, "isZero", IsZero, nodegitExternal);
            Nan::SetPrototypeMethod(tpl, "ncmp", Ncmp, nodegitExternal);
            Nan::SetPrototypeMethod(tpl, "strcmp", Strcmp, nodegitExternal);
            Nan::SetPrototypeMethod(tpl, "streq", Streq, nodegitExternal);
            Nan::SetPrototypeMethod(tpl, "tostrS", TostrS, nodegitExternal);
             Nan::SetMethod(tpl, "fromString", Fromstrp, nodegitExternal);
    ...
    Nan::Set(target, Nan::New("Oid").ToLocalChecked(), constructor_template);
  }
