...
nodegit::ConfigurableClassWrapper<GitPushOptionsTraits>::v8ConversionResult ConfigurableGitPushOptions::fromJavascript(nodegit::Context *nodegitContext, v8::Local<v8::Value> input) {
  if (!input->IsObject()) {
    return {
  ...
  // unpack the data into the correct fields
         {
          ...
          if (!maybeNumber.IsEmpty() && !maybeNumber->IsUndefined() && !maybeNumber->IsNull()) {
           ...
           {
          v8::Local<v8::Value> maybeNumber = nodegit::safeGetField(inputObj, "pbParallelism");
          if (!maybeNumber.IsEmpty() && !maybeNumber->IsUndefined() && !maybeNumber->IsNull()) {
            if (!maybeNumber->IsNumber()) {
              return {
            ...
            output->raw->pb_parallelism = static_cast<unsigned int>(maybeNumber->Int32Value(Nan::GetCurrentContext()).FromJust());
          }
        }
          {
          ...
          if (!maybeNestedObject.IsEmpty() && !maybeNestedObject->IsUndefined() && !maybeNestedObject->IsNull()) {
           ...
           {
          v8::Local<v8::Value> maybeNumber = nodegit::safeGetField(inputObj, "followRedirects");
          if (!maybeNumber.IsEmpty() && !maybeNumber->IsUndefined() && !maybeNumber->IsNull()) {
            if (!maybeNumber->IsNumber()) {
              return {
            ...
            output->raw->follow_redirects = static_cast<git_remote_redirect_t>(maybeNumber->Int32Value(Nan::GetCurrentContext()).FromJust());
          }
        }
