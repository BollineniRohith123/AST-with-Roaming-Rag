...
using namespace node;
  ...
  void GitOdbOptions::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    tpl->SetClassName(Nan::New("OdbOptions").ToLocalChecked());
    ...
    Nan::Set(target, Nan::New("OdbOptions").ToLocalChecked(), constructor_template);
  }

      // start field block
    NAN_METHOD(GitOdbOptions::Version) {
      v8::Local<v8::Value> v8ConversionSlot;

            unsigned int
           version =
          Nan::ObjectWrap::Unwrap<GitOdbOptions>(info.This())->GetValue()->version;
 // start convert_to_v8 block
  ...
  // end convert_to_v8 block
    ...
    // end field block
     // start field block
    NAN_METHOD(GitOdbOptions::OidType) {
      v8::Local<v8::Value> v8ConversionSlot;

            git_oid_t
           oid_type =
          Nan::ObjectWrap::Unwrap<GitOdbOptions>(info.This())->GetValue()->oid_type;
 // start convert_to_v8 block
