...
using namespace node;
  ...
  void GitStash::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    Local<External> nodegitExternal = Nan::New<External>(nodegitContext);
       ...
       v8::Local<Object> object = Nan::New<Object>();
         ...
         Nan::SetMethod(object, "drop", Drop, nodegitExternal);
         Nan::SetMethod(object, "foreach", Foreach, nodegitExternal);
         Nan::SetMethod(object, "pop", Pop, nodegitExternal);
         Nan::SetMethod(object, "save", Save, nodegitExternal);
         Nan::SetMethod(object, "saveWithOpts", SaveWithOpts, nodegitExternal);
...
// end convert_from_v8 block
  ...
  Nan::Callback *callback = new Nan::Callback(v8::Local<Function>::Cast(info[info.Length() - 1]));
  DropWorker *worker = new DropWorker(baton, callback, cleanupHandles);
...
void GitStash::Foreach_callback_promiseCompleted(bool isFulfilled, nodegit::AsyncBaton *_baton, v8::Local<v8::Value> result) {
  Nan::HandleScope scope;
...
// end convert_from_v8 block
  ...
  Nan::Callback *callback = new Nan::Callback(v8::Local<Function>::Cast(info[info.Length() - 1]));
  PopWorker *worker = new PopWorker(baton, callback, cleanupHandles);
...
// end convert_from_v8 block
  ...
  Nan::Callback *callback = new Nan::Callback(v8::Local<Function>::Cast(info[info.Length() - 1]));
  SaveWorker *worker = new SaveWorker(baton, callback, cleanupHandles);
...
/*
  * @param Repository repo
   * @param StashSaveOptions opts
    * @param Oid callback
   */
NAN_METHOD(GitStash::SaveWithOpts) {
  ...
  if (info.Length() == 1 || !info[1]->IsObject()) {
    return Nan::ThrowError("StashSaveOptions opts is required.");
  }
...
// end convert_from_v8 block
  ...
  Nan::Callback *callback = new Nan::Callback(v8::Local<Function>::Cast(info[info.Length() - 1]));
  SaveWithOptsWorker *worker = new SaveWithOptsWorker(baton, callback, cleanupHandles);
...
void GitStash::SaveWithOptsWorker::HandleErrorCallback() {
  if (!GetIsCancelled()) {
    v8::Local<v8::Object> err = Nan::To<v8::Object>(Nan::Error(ErrorMessage())).ToLocalChecked();
    Nan::Set(err, Nan::New("errorFunction").ToLocalChecked(), Nan::New("Stash.saveWithOpts").ToLocalChecked());
    v8::Local<v8::Value> argv[1] = {
      err
    };
    callback->Call(1, argv, async_resource);
  ...
  // end convert_to_v8 block
    ...
    if (baton->error) {
      ...
      if (baton->error->message) {
        ...
        err = Nan::To<v8::Object>(Nan::Error("Method saveWithOpts has thrown an error.")).ToLocalChecked();
      }
      Nan::Set(err, Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
      Nan::Set(err, Nan::New("errorFunction").ToLocalChecked(), Nan::New("Stash.saveWithOpts").ToLocalChecked());
      v8::Local<v8::Value> argv[1] = {
      ...
      if (!callbackFired) {
        v8::Local<v8::Object> err = Nan::To<v8::Object>(Nan::Error("Method saveWithOpts has thrown an error.")).ToLocalChecked();
        Nan::Set(err, Nan::New("errno").ToLocalChecked(), Nan::New(baton->error_code));
        Nan::Set(err, Nan::New("errorFunction").ToLocalChecked(), Nan::New("Stash.saveWithOpts").ToLocalChecked());
        v8::Local<v8::Value> argv[1] = {
          err
