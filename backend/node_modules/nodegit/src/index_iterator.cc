...
using namespace node;
  ...
  void GitIndexIterator::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    Nan::Set(target, Nan::New("IndexIterator").ToLocalChecked(), constructor_template);
  }
