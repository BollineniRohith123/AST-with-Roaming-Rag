...
using namespace node;
  ...
  void GitSignature::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    tpl->SetClassName(Nan::New("Signature").ToLocalChecked());
           ...
           Nan::SetMethod(tpl, "default", Default, nodegitExternal);
             Nan::SetMethod(tpl, "fromBuffer", FromBuffer, nodegitExternal);
             Nan::SetMethod(tpl, "create", Create, nodegitExternal);
             Nan::SetMethod(tpl, "now", Now, nodegitExternal);
           Nan::SetPrototypeMethod(tpl, "name", Name, nodegitExternal);
         Nan::SetPrototypeMethod(tpl, "email", Email, nodegitExternal);
         Nan::SetPrototypeMethod(tpl, "when", When, nodegitExternal);
    ...
    Nan::Set(target, Nan::New("Signature").ToLocalChecked(), constructor_template);
  }
...
// end convert_from_v8 block
  ...
  DefaultWorker *worker = new DefaultWorker(baton, callback, cleanupHandles);
