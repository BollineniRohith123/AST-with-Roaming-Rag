...
using namespace node;
  ...
  void GitBranchIterator::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    Nan::Set(target, Nan::New("BranchIterator").ToLocalChecked(), constructor_template);
  }
