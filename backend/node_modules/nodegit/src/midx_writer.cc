...
using namespace node;
  ...
  void GitMidxWriter::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    tpl->SetClassName(Nan::New("MidxWriter").ToLocalChecked());
    ...
    Nan::Set(target, Nan::New("MidxWriter").ToLocalChecked(), constructor_template);
  }
