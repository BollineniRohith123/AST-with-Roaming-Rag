...
using namespace node;
  ...
  void GitFilterList::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    tpl->SetClassName(Nan::New("FilterList").ToLocalChecked());
          ...
          Nan::SetPrototypeMethod(tpl, "applyToBlob", ApplyToBlob, nodegitExternal);
            Nan::SetPrototypeMethod(tpl, "applyToData", ApplyToData, nodegitExternal);
            Nan::SetPrototypeMethod(tpl, "applyToFile", ApplyToFile, nodegitExternal);
             Nan::SetMethod(tpl, "load", Load, nodegitExternal);
    ...
    Nan::Set(target, Nan::New("FilterList").ToLocalChecked(), constructor_template);
  }
...
// end convert_from_v8 block
  ...
  ApplyToBlobWorker *worker = new ApplyToBlobWorker(baton, callback, cleanupHandles);

        worker->Reference<GitFilterList>("filters", info.This());
...
// end convert_from_v8 block
  ...
  Nan::Callback *callback = new Nan::Callback(v8::Local<Function>::Cast(info[info.Length() - 1]));
  ApplyToDataWorker *worker = new ApplyToDataWorker(baton, callback, cleanupHandles);
...
// end convert_from_v8 block
  ...
  Nan::Callback *callback = new Nan::Callback(v8::Local<Function>::Cast(info[info.Length() - 1]));
  ApplyToFileWorker *worker = new ApplyToFileWorker(baton, callback, cleanupHandles);
