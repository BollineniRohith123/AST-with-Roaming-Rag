...
using namespace node;
  ...
  void GitLibgit2::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    Nan::HandleScope scope;
    Local<External> nodegitExternal = Nan::New<External>(nodegitContext);

       v8::Local<Object> object = Nan::New<Object>();
         Nan::SetMethod(object, "features", Features, nodegitExternal);
         Nan::SetMethod(object, "init", Init, nodegitExternal);
         Nan::SetMethod(object, "opts", Opts, nodegitExternal);
         Nan::SetMethod(object, "prerelease", Prerelease, nodegitExternal);
         Nan::SetMethod(object, "shutdown", Shutdown, nodegitExternal);
         Nan::SetMethod(object, "version", Version, nodegitExternal);
...
NAN_METHOD(GitLibgit2::Prerelease) {
  Nan::EscapableHandleScope scope;
