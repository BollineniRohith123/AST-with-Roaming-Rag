...
using namespace node;
  ...
  void GitOidarray::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    tpl->SetClassName(Nan::New("Oidarray").ToLocalChecked());
          ...
          Nan::SetPrototypeMethod(tpl, "dispose", Dispose, nodegitExternal);
           Nan::SetPrototypeMethod(tpl, "ids", Ids, nodegitExternal);
    ...
    Nan::Set(target, Nan::New("Oidarray").ToLocalChecked(), constructor_template);
  }

  
/*
     */
NAN_METHOD(GitOidarray::Dispose) {
