...
using namespace node;
  ...
  void GitOidShorten::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    Nan::Set(target, Nan::New("OidShorten").ToLocalChecked(), constructor_template);
  }
