...
using namespace node;
  ...
  void GitCommitGraphWriter::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    tpl->SetClassName(Nan::New("CommitGraphWriter").ToLocalChecked());
    ...
    Nan::Set(target, Nan::New("CommitGraphWriter").ToLocalChecked(), constructor_template);
  }
