...
using namespace node;
  ...
  void GitPathspec::InitializeComponent(v8::Local<v8::Object> target, nodegit::Context *nodegitContext) {
    ...
    tpl->SetClassName(Nan::New("Pathspec").ToLocalChecked());
          ...
          Nan::SetPrototypeMethod(tpl, "matchDiff", MatchDiff, nodegitExternal);
            Nan::SetPrototypeMethod(tpl, "matchIndex", MatchIndex, nodegitExternal);
            Nan::SetPrototypeMethod(tpl, "matchTree", MatchTree, nodegitExternal);
            Nan::SetPrototypeMethod(tpl, "matchWorkdir", MatchWorkdir, nodegitExternal);
            Nan::SetPrototypeMethod(tpl, "matchesPath", MatchesPath, nodegitExternal);
    ...
    Nan::Set(target, Nan::New("Pathspec").ToLocalChecked(), constructor_template);
  }
...
// end convert_from_v8 block
  ...
  MatchDiffWorker *worker = new MatchDiffWorker(baton, callback, cleanupHandles);

             worker->Reference<GitDiff>("diff", info[0]);
             worker->Reference("flags", info[1]);
         worker->Reference<GitPathspec>("ps", info.This());
...
// end convert_from_v8 block
  ...
  Nan::Callback *callback = new Nan::Callback(v8::Local<Function>::Cast(info[info.Length() - 1]));
  MatchIndexWorker *worker = new MatchIndexWorker(baton, callback, cleanupHandles);
...
// end convert_from_v8 block
  ...
  Nan::Callback *callback = new Nan::Callback(v8::Local<Function>::Cast(info[info.Length() - 1]));
  MatchTreeWorker *worker = new MatchTreeWorker(baton, callback, cleanupHandles);
...
// end convert_from_v8 block
  ...
  Nan::Callback *callback = new Nan::Callback(v8::Local<Function>::Cast(info[info.Length() - 1]));
  MatchWorkdirWorker *worker = new MatchWorkdirWorker(baton, callback, cleanupHandles);
